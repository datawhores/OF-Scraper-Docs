...
* [Command Reference](command-reference.md)
  ...
  * [Main Options](command-reference/common-option-groups/README.md)
    ...
    * [Download Options](command-reference/main-options/download-options.md)
    * [Advanced Program Options](command-reference/main-options/advanced-args.md)
  * [Scrape/Metadata Options](command-reference/scrape-metadata-options/README.md)
    ...
    * [Automation Options](command-reference/scrape-metadata-options/general-scraper-args.md)
