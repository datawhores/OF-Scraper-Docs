...
{% content-ref url="getting-started/config-options/setting-metadata-path.md" %}
[setting-metadata-path.md](getting-started/config-options/setting-metadata-path.md)
{% endcontent-ref %}
...
{% content-ref url="getting-started/config-options/file-output-options/" %}
[file-output-options](getting-started/config-options/file-output-options/)
{% endcontent-ref %}
